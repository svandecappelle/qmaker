...
public class UnionTest {
    ...
    @Test
    public void multiplesUnionMixedAllQueryEmbadded() {
        ...
        Query unionGlobal = new Query();
        unionGlobal.select("*");
        unionGlobal.from(union);

        Assert.assertEquals(unionGlobal.toString(), "SELECT * FROM (" + q1 + " UNION " + q2 + " UNION ALL " + q1 + ")");
    }
}
